...
methods_ru = {
    ...
    '7': 'Минимизация: Равномерный поиск, Метод половинного деления, Метод золотого сечения',
    '8': 'Метод Ньютона-Рафсона, Метод Больцано, Метод секущих',
    '9': 'Интервал унимодальности: С постоянным шагом, пропорциональным шагом, С шагом Свенна',
}
